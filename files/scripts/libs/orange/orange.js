...
e.find = function(n, r) {
var o = e.GetUtil.getFromGlobal(n), i = !1;
if (o && o instanceof t) {
...
var r, o;
if (1 == t.type) e[n] && e[n].dispose(); else if (2 == t.type) {
...
if (o.classType) {
if (e) if (e.$search) e.$search(i, t, n); else if ("object" == typeof e) for (var a in e) {
var c = i + "." + a;
...
var i = __read(o.value, 2), s = i[0], a = i[1];
if (0 === a.type || 4 === a.type) this[s] = this.createProperty(s); else if (1 === a.type) this[s] && this[s].reset(); else if (2 === a.type) {
...
var e, t, n = new (Object.getPrototypeOf(this).constructor)(), r = this.properties, o = function(e, t) {
if (0 === t.type) n[e] = i[e]; else if (1 === t.type) i[e] ? n[e] = i[e].clone() : n[e] = i.createProperty(e); else if (2 === t.type) {
...
var t = this.properties, n = function(n) {
var o, i, s, a, c = e[n], u = t.get(n);
...
h = r[n];
if (null == c) r[n] = []; else if (u.classType) {
if (r[n]) try {
...
var g = y.value;
if ((b = new u.classType()).setValue) b.setValue(g); else for (var v in g) b[v] = c[v];
r[n].push(b);
}
} catch (e) {
s = {
...
if (null == c) m.clear(); else for (var v in c) {
3 == u.type && (v = ~~v);
if (null == c[v]) m.delete(v); else if (m.has(v)) u.classType ? (b = m.get(v)).setValue(c[v]) : m.set(v, c[v]); else if (u.classType) {
var b;
...
+o + "" === o && (o = +o);
if (null == t[o]) r.delete(o); else if (r.has(o)) n ? (i = r.get(o)).setValue(t[o]) : r.set(o, t[o]); else if (n) {
var i;
...
+r + "" === r && (r = +r);
if (null == t[r]) e.delete(r); else if (e.has(r)) n ? (o = e.get(r)).setValue(t[r]) : e.set(r, t[r]); else if (n) {
var o;
...
var n = e.constructor.properties, r = n.get(t);
if (!r) {
r = {
type: 0,
classType: null,
...
if (o === t.LX || a.length > 4 && 112 == a[0] && 108 == a[1]) a = e.lz4XorDecode(a); else if (o === t.X || a.length > 4 && 112 == a[0] && 120 == a[1]) a = e.xorDecode(a); else if ((o === t.XTM || a.length > 3 && 112 == a[0] && 116 == a[1]) && n) {
var c = n.decryptMod({
data: a.buffer,
length: a.byteLength
});
...
if (t.headerObj) for (var o in t.headerObj) t.$xhr.setRequestHeader(o, t.headerObj[o]);
...
return e;
}(), s = new ArrayBuffer(1), a = function() {
function a() {
var r = this;
this._destroyed = !1;
this._sendData = {};
...
var n = this, r = this._frameTimer.now;
...
var o = JSON.stringify(this._connParam), i = this._url + "?p=" + encodeURIComponent(o) + "&e=" + this.connectOptions.encoding, s = this._tryConnectTimes < 2 && window.kcpconn, a = s && new window.kcpconn.KcpConnection(i) || new WebSocket(i);
...
var o = e.encodeMsg(r, this.connectOptions.encoding), i = this._sndQueue;
i.enqueue(o);
...
case "_sys/error":
if (r.error) console.error(r.error); else try {
...
var e = Date.now(), n = this._sm;
if (this._frameTimer.now > this._connectionTimeout) n.changeStateNextFrame(t.Reconnecting); else {
...
if (~~n.resp > 0) for (var o = this._asyncList; o.length > 0; ) {
var i = o[0];
if (n.resp === i.seq) {
i.resolve(n);
o.splice(0, 1);
...
if (this.syncAllCommand || this.syncCommands[r.cmd]) for (var o in r.decBody) if (this.root[o]) {
...
for (var n = e.split("."), r = t || window, o = 0; o < n.length; o++) if (null == (r = r[n[o]])) return r;
return r;
};
e.setFromGlobal = function(t, n, r) {
for (var o = t.split("."), i = r || window, s = 0; s < o.length; s++) if (s == o.length - 1) {
i[o[s]] = n;
...
for (var t, n = [], r = 0; r < e.length; r++) if ((t = e.charCodeAt(r)) < 128) n.push(t); else if (t < 2048) {
...
var i = [];
for (o = 0; o < e.length && 0 != e[o]; o++) if (0 == (128 & e[o])) i.push(e[o]); else if (0 == (64 & e[o])) i.push(e[o] % 128); else if (0 == (32 & e[o])) {
...
void 0 === o && (o = !1);
for (var i = 0; i < t.length; i++) if (e.hasStringAt(t, [ n ], i)) {
...
void 0 === n && (n = 4);
for (var r = "", o = [], i = 0; i < t.length; i++) for (var s = 0; s < t[i].length; s++) {
t[i][s] = "" + t[i][s];
...
void 0 === n && (n = !0);
var r = ~~(4294967295 * Math.random()), o = e.byteLength + 4;
