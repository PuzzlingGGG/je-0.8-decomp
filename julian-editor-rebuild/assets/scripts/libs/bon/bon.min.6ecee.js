	...
	var i = {},
		...
		n = function () {
			...
			t.prototype.decodeUTF8 = function (t, n, o) {
				var s = ~~n,
					a = void 0 === o ? t.byteLength : Math.min(t.byteLength, s + o);
				if (0 == (o = a - s)) return "";
				var h, d = o <= 32;
				if (d) {
					h = i;
	...
	var i = new Uint8Array(524288),
		e = function () {
			...
			t.prototype.writeUint8Array = function (t, i, e) {
				var r = ~~i,
					n = void 0 === e ? t.byteLength : Math.min(t.byteLength, r + e);
				if (!((e = n - r) <= 0)) {
					this.ensureBuffer(e);
...
(function (t) {
	var i = function () {
		...
		i.prototype.encodeLong = function (t) {
			this.dw.writeInt8(2);
			if ("number" == typeof t) this.dw.writeInt64(t);
			else {
