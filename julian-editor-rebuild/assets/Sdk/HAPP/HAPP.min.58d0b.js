! function (e) {
	...
	var e, t = new (function () {
		...
		return e.prototype.on = function (e, t, n) {
			...
			if (void 0 === t) this.eventMap[e] = [];
			else {
				var n = this.eventMap[e];
				if (n && n.length)
					for (var o = this.getCallbackIndex(n, t); - 1 !== o;) this.eventMap[e].splice(o, 1),
	...
	var n = e,
		o = cc.sys.os == cc.sys.OS_IOS,
		r = o ? "SDKMessager" : "com/hortorgames/gamesdk/SDKBridge",
		i = o ? "callNative:withMessage:" : "receiveMsgFromHSDK";
	...
	var S, A = "function" == typeof atob,
		...
		x = "function" == typeof Uint8Array.from ? Uint8Array.from.bind(Uint8Array) : function (e, t) {
	...
	var H, V, B = function () {
		...
		J = (V = ((H = {
			...
			var n = function () {
				...
				o = ["wxmini", "wxmini-log", "platform", "wxmini-test", "platform-test", "wxmini-dev", "platform-dev"],
				r = (t.TIMES_TYPE = {
				...
				o = function () {
					...
					return n(e, [{
						...
						value: function (e, t) {
							...
							var f = i || c;
							if (f)
								for (var d in u.times = {}, f) u.times[d] = this.mergeNum((i || {})[d], (c || {})[d]);
							return u;
						}
					}, {
						key: "getTemp",
				...
				o = function () {
					...
					return n(e, [{
						...
						value: function () {
							...
							if (!n) return e;
							var o = !!n.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/),
								r = n.match(/\((.+?)\)/g);
					...
					return function (e, t) {
						...
						value: function (e) {
							...
							return function () {
								var n = new e(),
									o = t.app.getWindow(),
									r = t.tracker(i.LOG_TYPE.RES_REQ, {
								...
								return n.origOpen = n.open, n.open = function (e, o) {
									...
									if (4 == n.readyState) {
										var e = n.getResponseHeader("Content-Length") || 0,
											o = n.status,
											a = n.responseText;
										200 == o ? function (e) {
